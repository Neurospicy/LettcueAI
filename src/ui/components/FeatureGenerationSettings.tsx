...
const LLAMA_NUMBER_FIELDS = [
  ...
  {
    key: "llamaAdaptiveTarget",
    labelKey: "featureGeneration.adaptiveTarget",
    range: ADVANCED_LLAMA_ADAPTIVE_TARGET_RANGE,
    decimals: 2,
    step: 0.01,
  },
  {
    key: "llamaAdaptiveDecay",
    labelKey: "featureGeneration.adaptiveDecay",
    range: ADVANCED_LLAMA_ADAPTIVE_DECAY_RANGE,
    decimals: 2,
    step: 0.01,
  },
  {
